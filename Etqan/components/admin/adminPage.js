...
function AdminPage() {
  return (
    ...
    <div class="p-4 mx-auto px-12 sm:ml-64 overflow-hidden">
      <div className=" grid grid-cols-3  mb-10  mt-2 p-8 w-full  bg-white border-4 border-[#00b4ba] rounded-2xl justify-between ">
